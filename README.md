...
- ✅ **Multi-class classification** — complete, including a tuning experiment on class imbalance (class_weight="balanced" made R2L detection worse, a genuine and honest finding about the dataset's limits)
